...
<body>
	<div class="col-lg-10">
		<form role="form" class="form-horizontal" action="/erp/dept/register"
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="orgname" name="deptno" placeholder="부서코드"
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="deptname" name="deptname" placeholder="부서명"
							class="form-control"  required>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="deptstep" name="deptstep" placeholder="순서"
							class="form-control" >
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="depttel" name="depttel"
							placeholder="대표전화번호" class="form-control" required>
