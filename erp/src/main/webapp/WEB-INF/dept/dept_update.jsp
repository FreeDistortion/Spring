...
<body>
	...
	%>
	<div class="col-lg-10">
		<form role="form" class="form-horizontal" action="/erp/dept/update"
			method="post">
			<fieldset>
				<div id="legend">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" value="<%=dept.getMgr_id()%>" name="mgr_id" />
					</div>
				</div>
				<div class="form-group">
					<!-- 등급-->
					...
					<div class="col-sm-3">
						<!-- 부서주소를 이곳에 출력하세요 -->
						<input type="text" value="<%=dept.getDeptaddr()%>"
							name="deptaddr" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<!-- 전화번호를 이곳에 출력하세요 -->
						<input type="text" value="<%=dept.getDepttel()%>" name="depttel" />
					</div>
				</div>
				<div class="form-group">
					<!-- Button -->
